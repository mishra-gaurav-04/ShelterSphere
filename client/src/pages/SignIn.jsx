  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
        ...
        <form  action="" className='flex flex-col gap-4'>
            <input type="text" placeholder='Email'  className='p-3 rounded-lg border border-gray-800' id='email'/>
            <input type="password" placeholder='Password' className='p-3 rounded-lg border border-gray-800' id='password'/>
